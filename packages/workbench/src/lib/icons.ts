...
export const ICONS: Readonly<Record<string, readonly IconShape[]>> = {
  ...
  /** 软盘：外框 + 上方的「磁盘」方块与下方标签条。 */
  save: [
    p("M8 10C8 8.9 8.9 8 10 8H33L40 15V38C40 39.1 39.1 40 38 40H10C8.9 40 8 39.1 8 38V10Z"),
    p("M17 8V18H32V8"),
    { kind: "rect", x: 15, y: 26, w: 18, h: 14 },
  ],
  /** 外链：左上开屏的方框 + 指向右上的箭头。 */
  external: [p("M22 10H11C9.9 10 9 10.9 9 12V37C9 38.1 9.9 39 11 39H36C37.1 39 38 38.1 38 37V26"), l(26, 22, 40, 8), p("M29 8H40V19")],
  /** 日历：外框 + 两根挂钉 + 表头分隔线（排期类控件用）。 */
  calendar: [{ kind: "rect", x: 8, y: 12, w: 32, h: 28 }, l(8, 21, 40, 21), l(17, 7, 17, 14), l(31, 7, 31, 14)],
  /** 表盘：圆环 + 时分针（时间选择用）。 */
  clock: [c(24, 24, 17), l(24, 24, 24, 14), l(24, 24, 32, 28)],
  /** 减号：只有一条横线（缩放 / 收起类控件用，与 plus 同形）。 */
  minus: [l(9, 24, 39, 24)],
  /** 逆时针旋转：与 refresh 同形镜像（refresh 是顺时针）。 */
  "rotate-left": [p("M8 24C8 33 15 40 24 40C33 40 40 33 40 24C40 18 37 12.7 32 10"), p("M32 4V10H26")],
  /** 顺时针旋转：复用 refresh 的弧与箭头。 */
  "rotate-right": [p("M40 24C40 33 33 40 24 40C15 40 8 33 8 24C8 18 11 12.7 16 10"), p("M16 4V10H22")],
};
