...
| `@greywork/editor`    | File system abstraction, Git operations, CodeMirror editor layer. Currently uses in-memory mocks; real implementations bridge to Tauri plugins.                                                           |
...
- Rust host code lives in `apps/desktop/src-tauri/src/`.
